...
import { COMPANY, NAV_LINKS_FOOTER, LEGAL_LINKS } from "@/lib/constants";
        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              <a
                href="https://facebook.com/happystoreshop"
                target="_blank"
              ...
              <a
                href="https://x.com/happystoreshop"
                target="_blank"
                rel="noopener noreferrer"
                className="text-slate-400 transition-colors hover:text-white"
              ...
              <a
                href="https://instagram.com/happystoreshop"
                target="_blank"
                rel="noopener noreferrer"
                className="text-slate-400 transition-colors hover:text-white"
